...
export const welcomeMessageCopyQueryAtom = atomWithQuery<
  ReturnType<typeof welcomeMessage.fetchCopy>,
  unknown
>((get) => ({
  queryKey: ["welcome_message_copy"],
  copyComponent: welcomeMessage,
  queryFn: welcomeMessage.fetchCopy,
}));
