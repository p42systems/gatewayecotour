...
export const AudioPlayer = styled(ReactAudioPlayer)((props) => ({
  maxWidth: "100%",
  margin: "5px 0",
  marginBottom: "15px",
  border: `5px solid ${props.theme.colors.primary}`,
...
export const HeaderImage = styled.img(() => ({
  ...
  margin: 0,
  padding: 0,
  transform: `translateY(calc(-300px / 2)) translateX(calc(-300px / 2))`,
  "@media screen and (max-width: 1028px)": {
    width: "175px",
    transform: `translateY(calc(-175px / 2)) translateX(calc(-175px / 2))`,
  },
}));
